class BookmarksController < ApplicationController
  def index
    ...
    @bookmarks = @q.result(:distinct => true).includes(:artwork, :folder).page(params[:page]).per(10)
  ...
  def create
    ...
    @bookmark.artwork_id = params[:artwork_id]
    @bookmark.folder_id = params[:folder_id]
